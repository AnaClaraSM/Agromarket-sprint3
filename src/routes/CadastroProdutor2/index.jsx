        ...
        <form onSubmit={handleSubmit} className="form-group">
          <div className="row pt-3">
            ...
            <div className="col-3">
              ...
              <input type="text" className="form-control input-color p-3" name="nomeFantasia" onChange={handleChange} />
            </div>
            {/* CEP */}
            <div className="col-3">
              <label className="form-label mt-4 fw-semibold">CEP</label>
              <input type="text" className="form-control input-color p-3" name="cep" onChange={handleChange} />
            </div>
