                        ...
                        <form onSubmit={validarFormulario} className="form-group">
                            <div className="row">
                                ...
                                <div className="col-3">
                                    ...
                                    <input type="text" className="form-control input-color" name="nomeFantasia" value={formData.nomeFantasia} onChange={handleChange} />
                                </div>

                                {/* Tamanho da Propriedade */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">TAMANHO DA PROPRIEDADE</label>
                                    <select className="form-control input-color" name="tamanhoPropriedade" value={formData.tamanhoPropriedade} onChange={handleChange}>
                                ...
                                <div className="col-3">
                                    ...
                                    <input type="text" className="form-control input-color" name="cep" value={formData.cep} onChange={handleChange} />
                                </div>

                                {/* Estado */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">ESTADO</label>
                                    <input type="text" className="form-control input-color" name="estado" value={formData.estado} onChange={handleChange} />
                                </div>

                                {/* CNPJ */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">CNPJ</label>
                                    <input type="text" className="form-control input-color" name="cnpj" value={formData.cnpj} onChange={handleChange} />
                                </div>

                                {/* Tipo de Produção */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">TIPO DE PRODUÇÃO</label>
                                    <select className="form-control input-color" name="tipoProducao" value={formData.tipoProducao} onChange={handleChange}>
                                        <option value="">Selecione...</option>
                                ...
                                <div className="col-3">
                                    ...
                                    <input type="text" className="form-control input-color" name="cidade" value={formData.cidade} onChange={handleChange} />
                                </div>

                                {/* País */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">PAÍS</label>
                                    <input type="text" className="form-control input-color" name="pais" value={formData.pais} onChange={handleChange} />
                                </div>
                            </div>
