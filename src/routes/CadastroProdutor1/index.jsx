                        ...
                        <form onSubmit={validarFormulario} className="form-group">
                            ...
                            <div className="row">
                                ...
                                <div className="col-3">
                                    ...
                                    <input type="text" className="form-control input-color" name="nomeCompleto" value={formData.nomeCompleto} onChange={handleChange} />
                                </div>

                                {/* CPF */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">CPF</label>
                                    <input type="text" className="form-control input-color" name="cpf" value={formData.cpf} onChange={handleChange} />
                                </div>

                                {/* Email */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">EMAIL</label>
                                    <input type="email" className="form-control input-color" name="email" value={formData.email} onChange={handleChange} />
                                </div>

                                {/* Senha */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">SENHA</label>
                                    <input type="password" className="form-control input-color" name="senha" value={formData.senha} onChange={handleChange} />
                                </div>

                                {/* Data de Nascimento */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">DATA DE NASCIMENTO</label>
                                    <input type="date" className="form-control input-color" name="dataNascimento" value={formData.dataNascimento} onChange={handleChange} />
                                </div>

                                {/* RG */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">RG</label>
                                    <input type="text" className="form-control input-color" name="rg" value={formData.rg} onChange={handleChange} />
                                </div>

                                {/* Telefone */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">TELEFONE</label>
                                    <input type="text" className="form-control input-color" name="telefone" value={formData.telefone} onChange={handleChange} />
                                </div>

                                {/* Confirmar Senha */}
                                <div className="col-3">
                                    <label className="form-label mt-4 fw-semibold">CONFIRME A SENHA</label>
                                    <input type="password" className="form-control input-color" name="confirmarSenha" value={formData.confirmarSenha} onChange={handleChange} />
                                </div>
                            </div>
